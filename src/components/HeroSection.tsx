  ...
  return (
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
            <p className="text-[19px] md:text-[21px] text-foreground leading-relaxed intro-text">
          ...
          <p className="text-[19px] md:text-[21px] text-foreground leading-relaxed intro-text intro-text-display">

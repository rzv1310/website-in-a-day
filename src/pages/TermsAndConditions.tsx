    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto py-16 px-6">
        ...
        <div className="space-y-8 font-body text-foreground/80 leading-relaxed text-[17px]">
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">1. Introducere</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">2. Definiții</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">3. Conturile</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">4. Proprietate intelectuală</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">5. Limitarea răspunderii</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">6. Reziliere</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">7. Modificări ale Serviciului</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">8. Modificări ale Termenilor</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">9. Politica de rambursare</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">10. Legea aplicabilă</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">11. Contactați-ne</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">12. Descrierea serviciilor și obligațiile clientului</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">13. Condiții de plată</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">14. Forță majoră</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">15. Confidențialitate</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3 font-display">16. Legătura cu alte politici</h2>
            ...
            <ul className="mt-2 list-disc list-inside space-y-1">
              <li><Link to="/cookies" title="Politica de Cookies" className="text-primary hover:underline">Politica de Cookies</Link> – descrie modul în care utilizăm cookie-urile și tehnologiile similare pe site-ul nostru.</li>
              <li><Link to="/gdpr" title="Politica GDPR" className="text-primary hover:underline">Politica de Confidențialitate (GDPR)</Link> – detaliază modul în care colectăm, utilizăm și protejăm datele dumneavoastră personale, în conformitate cu Regulamentul General privind Protecția Datelor.</li>
            </ul>

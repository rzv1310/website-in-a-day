  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <p className="text-lg font-body tracking-[0.3em] uppercase text-primary mb-8">
            Premium Web Design
          </p>
        ...
        >
          <a
            href="#pregatire"
            className="inline-flex items-center gap-2 bg-gradient-gold text-primary-foreground font-light px-10 py-4 rounded-sm tracking-wider uppercase text-lg hover:opacity-90 transition-opacity"
          >
